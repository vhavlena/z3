...
Z3-Noodler is based on the SMT solver [Z3 v4.12.6](https://github.com/Z3Prover/z3/releases/tag/z3-4.12.6), in which it replaces the solver for the theory of strings. 
